...
const ProfileHeader = ({ studentData }) => {
  return (
    <div className="flex flex-col md:flex-row justify-between items-center sm:items-start gap-6 mb-8 p-6 sm:p-8 bg-gradient-to-br from-blue-50 via-purple-50 to-indigo-50 dark:from-gray-800 dark:via-gray-900 dark:to-purple-900/30 rounded-2xl border border-blue-100 dark:border-gray-700 shadow-xl dark:shadow-2xl backdrop-blur-sm">
      
      <div className="flex flex-col sm:flex-row sm:items-center items-center gap-6 text-center sm:text-left w-full">
        <div className="relative">
          <img
            src={studentData.avatar}
            alt={studentData.name}
            className="w-24 h-24 sm:w-28 sm:h-28 rounded-full border-4 border-white dark:border-gray-600 shadow-xl ring-4 ring-blue-100 dark:ring-gray-700"
          />
      ...
      <div className="flex flex-row justify-center sm:justify-end items-center gap-4 sm:gap-6 w-full md:pt-6">
        <div className="flex items-center gap-3 px-4 py-2 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-xl border border-yellow-200 dark:border-yellow-800/50">
        ...
        <div className="flex items-center gap-3 px-4 py-2 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-xl border border-purple-200 dark:border-purple-800/50">
